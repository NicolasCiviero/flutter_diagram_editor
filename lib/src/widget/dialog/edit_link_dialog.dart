...
import 'package:diagram_editor/src/widget/dialog/pick_color_dialog.dart';
                      ...
                      Container(
                        child: DropdownButton<LineType>(
                          ...
                          onChanged: (LineType? newValue) {
                            setState(() {
                              lineTypeDropdown = newValue ?? LineType.solid;
                            });
                          },
                      ...
                      Container(
                        child: DropdownButton<ArrowType>(
                          ...
                          onChanged: (ArrowType? newValue) {
                            setState(() {
                              arrowTypeDropdown = newValue ?? ArrowType.arrow;
                            });
                          },
                    ...
                    children: [
                      Container(
                        child: DropdownButton<ArrowType>(
                          ...
                          onChanged: (ArrowType? newValue) {
                            setState(() {
                              backArrowTypeDropdown = newValue ?? ArrowType.arrow;
                            });
                          },
                          items: ArrowType.values.map((ArrowType arrowType) {
                            return DropdownMenuItem<ArrowType>(
...
class ShowItem extends StatelessWidget {
  ...
  const ShowItem({Key? key, required this.text, required this.isShown, required this.onTap})
      : super(key: key);
